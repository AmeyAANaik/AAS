    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/vendors/invoice-template-profiles").hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/sample", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/analyze", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/mapping/preview", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/mapping/save", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/preview", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/profile/preview", "POST")).hasRole("ADMIN")
                .requestMatchers(new AntPathRequestMatcher("/api/vendors/*/invoice-template/profile/save", "POST")).hasRole("ADMIN")
