# Client Pitch Pack (Start Here)

Use these files to present the Ivy Sales Extension proposal to the client:
...
- Copy `CLIENT_PITCH_DECK.md` into your PPT tool slide by slide.
- Use `FIGMA_HANDOFF_SPEC.md` for design production in Figma.
